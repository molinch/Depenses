...
{
    [Register("DepenseView")]
    public class DepenseView : MvxViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            var source = new MvxSimpleTableViewSource(_tableView, typeof(DepenseCell), DepenseCell.Identifier);
            ...
            var set = this.CreateBindingSet<DepenseView, Core.ViewModels.DepenseViewModel>();
